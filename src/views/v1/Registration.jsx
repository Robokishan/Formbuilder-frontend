              ...
              <Form onSubmit={onFormSubmit} role="form">
                <FormGroup>
                  <InputGroup className="input-group-alternative mb-3">
                    ...
                    <Input onChange={ e => onChange(e)  } name="name" placeholder="Name" type="text" />
                  </InputGroup>
                </FormGroup>
                <FormGroup>
                  <InputGroup className="input-group-alternative mb-3">
                ...
                <div className="text-center">
                  <Button disabled={disable} className="mt-4" color="primary" type="submit">
                    Create account
                  </Button>
                </div>
                <div className="text-center">
                  <Button onClick={ e => props.history.push("/auth/login") } className="mt-4" color="primary" type="button">
                    Sign in
                  </Button>
                </div>
              </Form>
